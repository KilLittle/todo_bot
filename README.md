...
**Оптимизации:**
1. Объединил связанные функции в одну строку через `<br>` для компактности
2. Добавил жирное выделение ролей для визуальной иерархии
3. Сохранил все исходные пункты, убрав дублирующие формулировки

Для более сложного форматирования (цвета, иконки) можно использовать HTML-таблицы — нужен ли такой вариант?
