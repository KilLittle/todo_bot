...
Вот таблица с разбивкой по ролям в формате Markdown (два столбца):

````markdown
| **Роль**          | **Функционал**                                                                 |
|--------------------|--------------------------------------------------------------------------------|
| **Администраторы** | - Управление пользователями (добавление/просмотр)<br>- Полный доступ ко всем функциям системы |
| **Методисты**      | - Управление расписанием практик<br>- Рассылка уведомлений<br>- Назначение преподавателей<br>- Просмотр списков (студенты/преподаватели) |
| **Преподаватели**  | - Просмотр назначенных студентов<br>- Создание/проверка заданий<br>- Доступ к функциям методиста (по запросу) |
| **Студенты**       | - Просмотр расписания<br>- Подача заявлений<br>- Отслеживание заданий и дедлайнов<br>- Связь с преподавателем |
````
