# Планировщик задач для автоматизации учебного процесса

Бот для управления учебными практиками студентов с ролевой системой (администраторы, методисты, преподаватели, студенты) [доступен по ссылке](https://t.me/myiv_todo_bot).
